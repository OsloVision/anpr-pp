...
class TestNorwegianRegistryRegex(unittest.TestCase):
    ...
    def test_regex_matches_html_content(self):
        ...
        self.assertEqual(match.group(0), expected_match, f"Full match should be '{expected_match}'")
    ...
    def test_regex_with_different_counts(self):
        ...
        for text, expected_count in test_cases:
            with self.subTest(text=text, expected_count=expected_count):
                ...
                self.assertEqual(match.group(1), expected_count, f"Should capture count '{expected_count}'")
    ...
    def test_original_html_example(self):
        ...
        self.assertEqual(match.group(1), "1", "Should capture count '1' from the original example")
